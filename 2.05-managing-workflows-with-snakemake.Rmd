...
deprecated by Snakemake.  The cluster-donfig file was a YAML file that you could pass to Snakemake,
...
But, we certainly would want to run each of those jobs separately in a cluster
...
To lump multiple connected subgraphs together you can use the `--group-
