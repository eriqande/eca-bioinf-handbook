...
3. Use your alias `myjobs` (if you have created it) to see what jobs you have running.
    ...
    ```
4. Navigate to your scratch directory.  On SUMMIT your scratch directory will be at a path like this
    ```{sh, eval=FALSE}
    /scratch/summit/wcfunk\@colostate.edu/
    ```
    You can make symbolic link that in your home directory like this:
    ```{sh, eval=FALSE}
    cd
    ln -s /scratch/summit/wcfunk\@colostate.edu/
    ```
...
13. Index the genome with `bwa` in order to align reads to it:
    ...
    - Navigate to `~/scratch/tchinook-play/genome/` and list the files there.  These new files
