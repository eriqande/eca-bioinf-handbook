...
never do it!  All of your hardcore computation on a cluster _has_ to be done in scheduled manner on
...
Before launching ourselves into the commands used to _launch_ or _schedule_ jobs we will explore the SLURM commands that
